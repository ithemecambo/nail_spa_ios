...
@objc public class KeyboardAvoiding: NSObject {
    ...
    @objc public static var padding: CGFloat = 15 {
        willSet {
    ...
    public static var fadeViews: [UIView] = []
    public static var isUpdateKeyboard: ((Bool, CGFloat) -> ())?
    ...
    class func didChange(_ notification: Foundation.Notification) {
        ...
        if keyboardFrame.size.height == 0 && (UIUserInterfaceIdiom.pad == UIUserInterfaceIdiom.pad) {
        ...
        if isKeyBoardShowing {
            ...
            for triggerView in self.triggerViews {
                ...
                if keyboardHeightDiff != 0 {
                    ...
                    let windowScene = UIApplication.shared.connectedScenes.first as? UIWindowScene
                    switch windowScene?.windows.first?.windowScene?.interfaceOrientation {
        ...
        isUpdateKeyboard?(isKeyBoardShowing, animationDuration)
    }
